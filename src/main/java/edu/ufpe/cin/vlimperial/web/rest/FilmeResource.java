...
public class FilmeResource {
    ...
    @PostMapping("/filmes")
    @Timed
    public ResponseEntity<Filme> createFilme(@Valid @RequestBody Filme filme) throws URISyntaxException {
    ...
    @PutMapping("/filmes")
    @Timed
    public ResponseEntity<Filme> updateFilme(@Valid @RequestBody Filme filme) throws URISyntaxException {
    ...
    /**
     * SEARCH  /_search/filmes?query=:query : search for the filme corresponding
     * to the query.
     *
     * @param query the query of the filme search
     * @return the result of the search
     */
    @GetMapping("/_search/filmes")
    @Timed
    public List<Filme> searchFilmes(@RequestParam String query) {
        log.debug("REST request to search Filmes for query {}", query);
        return filmeService.search(query);
    }
