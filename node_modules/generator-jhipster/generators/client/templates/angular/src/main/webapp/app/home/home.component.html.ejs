...
<div class="row">
    ...
    <div class="col-md-9">
        <h1 class="display-4" jhiTranslate="home.title">Bem Vido a Video Locadora Imperial!</h1>
        <p class="lead" jhiTranslate="home.subtitle">Acesso o menu para acessar as funcionalidades após login</p>
